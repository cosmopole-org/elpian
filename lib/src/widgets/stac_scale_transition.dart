...
class StacScaleTransition {
  static Widget build(StacNode node, List<Widget> children) {
    return _StacScaleTransitionWidget(node: node, children: children);
  }
}

class _StacScaleTransitionWidget extends StatefulWidget {
  final StacNode node;
  final List<Widget> children;

  const _StacScaleTransitionWidget({
    required this.node,
    required this.children,
  });

  @override
  State<_StacScaleTransitionWidget> createState() =>
      _StacScaleTransitionWidgetState();
}

class _StacScaleTransitionWidgetState extends State<_StacScaleTransitionWidget>
