...
class StacSizeTransition {
  static Widget build(StacNode node, List<Widget> children) {
    return _StacSizeTransitionWidget(node: node, children: children);
  }
}

class _StacSizeTransitionWidget extends StatefulWidget {
  final StacNode node;
  final List<Widget> children;

  const _StacSizeTransitionWidget({
    required this.node,
    required this.children,
  });

  @override
  State<_StacSizeTransitionWidget> createState() =>
      _StacSizeTransitionWidgetState();
}

class _StacSizeTransitionWidgetState extends State<_StacSizeTransitionWidget>
