...
class _CanvasDemoPageState extends State<CanvasDemoPage> {
  ...
  Widget _buildShapesTab() {
    ...
    return _engine.renderFromJson(
      isolateComponentChildren(json, 'canvas-shapes'),
    );
  }
  ...
  Widget _buildPathsTab() {
    ...
    return _engine.renderFromJson(
      isolateComponentChildren(json, 'canvas-paths'),
    );
  }
  ...
  Widget _buildTextTab() {
    ...
    return _engine.renderFromJson(
      isolateComponentChildren(json, 'canvas-text'),
    );
  }
  ...
  Widget _buildGradientsTab() {
    ...
    return _engine.renderFromJson(
      isolateComponentChildren(json, 'canvas-gradients'),
    );
  }
  ...
  Widget _buildTransformsTab() {
    ...
    return _engine.renderFromJson(
      isolateComponentChildren(json, 'canvas-transforms'),
    );
  }
}
