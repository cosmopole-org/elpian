...
class _LandingPageState extends State<LandingPage> {
  ...
  Future<String> _loadLandingPageJson() async {
    return rootBundle.loadString('assets/examples/landing_page.json');
  }
        ...
        // Hero Section
        {
          ...
          'children': [
            ...
            },
            {
              ...
              'props': {
                'text':
                    'A high-performance Flutter rendering engine that transforms JSON definitions and HTML+CSS into native Flutter widgets.'
              },
              'style': {
                'color': '#94A3B8',
                'fontSize': 18,
