...
class StacPulse {
  static Widget build(StacNode node, List<Widget> children) {
    return _StacPulseWidget(node: node, children: children);
  }
}

class _StacPulseWidget extends StatefulWidget {
  final StacNode node;
  final List<Widget> children;

  const _StacPulseWidget({
    required this.node,
    required this.children,
  });

  @override
  State<_StacPulseWidget> createState() => _StacPulseWidgetState();
}

class _StacPulseWidgetState extends State<_StacPulseWidget>
