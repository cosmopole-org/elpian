...
void main() {
  testWidgets('nested flex:1 row in an unbounded-width context lays out',
      (tester) async {
          ...
          'children': [
            {
              ...
              'children': [
                {
                  'type': 'div',
                  'style': {'flex': 1, 'height': 12, 'backgroundColor': '#a00'}
                },
                {
                  'type': 'div',
                  'style': {'flex': 1, 'height': 12, 'backgroundColor': '#0a0'}
                },
              ],
            },
          ],
