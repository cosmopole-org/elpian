...
void main() {
  ...
  testWidgets(
      'facility section (grid + progress + card + button) renders cleanly',
      (tester) async {
    tester.view.physicalSize = const Size(412, 915);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.reset);

    Map<String, dynamic> sp(String t) => {
          'type': 'span',
          'props': {'text': t}
        };
    final tile = {
          ...
          'children': [
            {
              ...
              'style': {
                'height': 6,
                'width': '60%',
                'backgroundColor': 'rgba(127,216,198,1)'
              }
            }
          ]
        },
    ...
    final card = {
      ...
      'style': {
        ...
        'padding': 12,
        'borderWidth': 1,
        'borderColor': 'rgba(216,185,120,0.18)'
      },
      'children': [
        {
          'type': 'div',
          ...
          'children': [sp('Tax income'), sp('+8/min')]
        },
      ],
    };
    final trainBtn = {
      'type': 'button',
      'props': {'text': 'Train Swordsman'},
      'events': {'click': '__btr'},
      'style': {
        'textAlign': 'center',
        'fontWeight': 800,
    ...
    await tester.pumpWidget(MaterialApp(
        home: Scaffold(
            body: SingleChildScrollView(child: engine.renderFromJson(panel)))));
    await tester.pump();
